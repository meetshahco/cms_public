...
function NavItem({ href, label, isActive }: { href: string; label: string; isActive: boolean }) {
    ...
    return (
        ...
        >
            ...
            <span className="invisible text-sm font-medium whitespace-nowrap">{label}</span>
...
export function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6 md:px-12 backdrop-blur-sm">
            <div className="mx-auto max-w-5xl flex items-center justify-between w-full">
                {pathname !== "/" ? (
                    ...
                    <Link href="/" className="text-xl font-bold text-white font-heading tracking-tight drop-shadow-md">
                        Meet Shah
                    </Link>
                )}
                <div className="flex items-center gap-6">
                    ...
                    >
                        ...
                        <span
                            className="invisible whitespace-nowrap text-sm font-medium transition-all duration-300 pointer-events-none"
                            style={{
                                paddingLeft: isContactCta ? "1.5rem" : "0.75rem",
                                paddingRight: isContactCta ? "1.5rem" : "0.75rem",
                                paddingTop: isContactCta ? "0.5rem" : "0.5rem",
                                paddingBottom: isContactCta ? "0.5rem" : "0.5rem",
                            }}
                        >
